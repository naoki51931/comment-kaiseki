...
function AdminPanel({users,games,error,apiFetch}:{users:AdminUser[];games:AdminGame[];error:string;apiFetch:(path:string,init?:RequestInit)=>Promise<Response>}){
